...
export default function StatsBar({ currentCount, totalCount }) {
  return (
    <div className="absolute bottom-5 left-5 z-40 flex flex-col items-start space-y-1.5 pointer-events-none">
      ...
      {/* 1. Job Alerts CTA Pill */}
      <a
        href={GOOGLE_FORM_URL}
        target="_blank"
        rel="noopener noreferrer"
        className="pointer-events-auto inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-xl text-xs font-bold text-white bg-[#ff5722] hover:bg-[#f4511e] shadow-md transition cursor-pointer"
      >
